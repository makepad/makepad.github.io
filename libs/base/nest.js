...
module.exports = class Nest extends require('base/class'){
	...
	$compileVerbs(className, sourceClass){
		...
		if(sourceProto.onCompileVerbs){
			if(sourceProto.onCompileVerbs(this)) return
		}
