...
module.exports = class CodeText extends require('shaders/text'){
	...
	pixel() {$
		...
		this.viewport((this.textureCoords - vec2(this.tx1, this.ty1)) * this.fontTextureSize * 0.07)
		this.shape = (-sigDist - 0.5 / this._aa)
		//this.shape += 0.1 * sin(this.time + this.ppos.y + this.ppos.y)
		//this.circle(0.6, -0.79, 0.6)
