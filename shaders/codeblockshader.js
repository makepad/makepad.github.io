module.exports = require('shader').extend(function QuadShader(proto){
	...
	proto.pixel = function(){$
		...
		//botField *= 0.2
		var grabScale = 1.
		var grabSize = vec2(.5*(this.bottomSize.x), .5*(this.h3*grabScale))
		var grabPos = vec2(0., this.h2 - this.h3+this.h)
		...
		var gloop = 4.
		var field = this.blend(this.blend(this.blend(topField,botField, 1.), sideField, gloop),grabField,gloop)
