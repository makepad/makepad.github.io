...
var sha224 = function(message, bs58mh) {
	return sha256(message, bs58mh, is224)
}

var sha256 = function(message, bs58mh, is224) {
	var notString = typeof(message) != 'string'
	if(notString && message.constructor == global.ArrayBuffer) {
	...
	if(bs58mh){
		...
		var bs58 = ''
		// pad it
		for(var s = 0; data[s] === 0 && s < data.length; s++){
			bs58 += BS58[0]
		}
		// generate it
